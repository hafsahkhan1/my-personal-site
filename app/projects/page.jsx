    ...
    <div style={{margin: "30px"}}>
      ...
      <div style={{display: "flex", flex: "row", alignItems:"center"}}>
        <div style={{marginBottom: "50px"}}>
          ...
          <p style={{whiteSpace: "pre"}}><b>Hackathon Participant</b>    |    <ActiveLink linkText={"Github Repo"} linkSrc="https://github.com/ToppiTheThinker/spark-hacks-2026" isMenu={false}/>    |    UIC    |    <i>Chicago, IL</i></p>
          <p>
        ...
        <ImageCarousel images={CLImgs}/>
      </div>

      <div style={{display: "flex", flex: "row", alignItems:"center"}}>
        <div style={{marginRight: "30px"}}>
          <ImageCarousel images={CCWImgs}/>
        </div>
        <div style={{marginBottom: "50px", textAlign:"right"}}>
          <h5 style={{marginBottom: "0px"}}>UncommonHacks 2025: Climate Change Warriors</h5>
          <p style={{whiteSpace: "pre"}}><b>Hackathon Participant</b>    |    <ActiveLink linkText={"Github Repo"} linkSrc="https://github.com/abyssaldragonz/UncommonHacks2025-ClimateWarriors" isMenu={false}/>    |    Play it <ActiveLink linkText={"here!"} linkSrc="https://play.unity.com/en/games/e4f3e200-e539-42d9-a0c1-f05f939b6fda/webgl-builds" isMenu={false}/>    |    UChicago    |    <i>Chicago, IL</i></p>
          <p>
      ...
      <div style={{display: "flex", flex: "row", alignItems:"center"}}>
        <div style={{marginBottom: "30px"}}>
          ...
          <p style={{whiteSpace: "pre"}}><b>Hackathon Participant</b>    |    <ActiveLink linkText={"Github Repo"} linkSrc="https://github.com/michelle-tanner/sparkhacks2025" isMenu={false}/>    |    Check it out <ActiveLink linkText={"here!"} linkSrc="https://toppithethinker.github.io/sparkhacks2025/" isMenu={false}/>     |     UIC    |    <i>Chicago, IL</i></p>
          <p>
