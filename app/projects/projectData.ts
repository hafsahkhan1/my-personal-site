...
import { PTSkills } from "./skills";
import { CCWSkills } from "./skills";
import { CLSkills } from "./skills";
import { pwSkills } from "./skills";
...
export const projectData: project[] = [
    {
        id: 1,
        title: "WiCS Wired: Dev Project Spring 2026 (Personal Website)",
        snap: "Personal Site",
        role: "Dev Participant",
        repo: "https://github.com/hafsahkhan1/my-personal-site",
        link: "https://hafsahs-website.vercel.app/",
        place: "UIC",
        location: "Chicago, IL",
        desc1: "Current Project!",
        desc2: `As part of the spring semester WiCS dev project, I, along with a group of peers, have spent the
    ...
    {
        id: 2,
        title: "SparkHacks 2026: Corporate Ladder",
        snap: "Web Game",
        role: "Hackathon Participant",
        repo: "https://github.com/ToppiTheThinker/spark-hacks-2026",
        place: "UIC",
        location: "Chicago, IL",
        desc1: `SparkHacks is definitely my favorite hackathon (I'm only a little biased!), and this was proven to be
        ...
        desc2: `This year's hackathon was cinema-themed, and as a result, we decided to build a game that focused on
        ...
        desc3: `In the game, which was built as a single website using React and NextJS, and styled with Tailwind CSS,
    ...
    {
        id: 3,
        title: "UncommonHacks 2025: Climate Change Warriors",
        role: "Hackathon Participant",
        snap: "Unity Game",
        repo: "https://github.com/abyssaldragonz/UncommonHacks2025-ClimateWarriors",
        link: "https://play.unity.com/en/games/e4f3e200-e539-42d9-a0c1-f05f939b6fda/webgl-builds",
        place: "UChicago",
        location: "Chicago, IL",
        desc1: `UncommonHacks was an interesting experience, mostly because all of the members of my team were totally
        ...
        desc2: `Throughout the design process and actually developing the game, we really wanted to focus on telling a
        ...
        desc3: `Although it was pretty daunting (to me at least) to try something completely new and without much structure
    ...
    {
        id: 4,
        title: "SparkHacks 2025: Pod Thai",
        snap: "Website",
        role: "Hackathon Participant",
        repo: "https://github.com/michelle-tanner/sparkhacks2025",
        link: "https://toppithethinker.github.io/sparkhacks2025/",
        place: "UIC",
        location: "Chicago IL",
        desc1: `SparkHacks 2025 was an extremely fun experience for me, as it was my first hackathon after starting
        ...
        desc2: `At this hackathon, there were a number of different tracks to develop projects for and submit to. We
                ...
                we were building.`,
        desc3: `Although we didn't end up winning the hackathon, it proved to be an extremely valuable experience for
