...
const experience = () => {
  ...
  return (
    <div style={{margin: "30px"}} > 
      <Menu/>
      <div // style={{backgroundImage: isDark ? `url("/backgrounds/dark/Group 26.png")` : `url("/backgrounds/light/Group 26.png")`,
           // backgroundPosition: '102% 75%', backgroundRepeat: 'repeat-y', backgroundSize: '40%'}} 
            >
      <h3>experience.</h3>
